/*
    ...
    Url: https://www.codewars.com/kata/program-a-calculator-number-1-points-in-3d-space/php
*/
...
class Point {
  ...
  public function getDistanceFromOrigin() {
    return sqrt(array_sum([ $this->x ** 2, $this->y ** 2, $this->z ** 2 ]));
  }

  public function getDistanceFromPoint(Point $point) {
    return sqrt(array_sum([ ($this->x - $point->x) ** 2, ($this->y - $point->y) ** 2, ($this->z - $point->z) ** 2 ]));
  }
}